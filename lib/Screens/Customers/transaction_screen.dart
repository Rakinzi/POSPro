...
class CustomerAllTransactionScreen extends StatefulWidget {
  const CustomerAllTransactionScreen({super.key}) ;
                              ...
                              Row(
                                ...
                                children: [
                                  Container(
                                    ...
                                    decoration: BoxDecoration(color: const Color(0xff0dbf7d).withValues(alpha: 0.1), borderRadius: const BorderRadius.all(Radius.circular(10))),
                                    child: Text(
