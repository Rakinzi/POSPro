                ...
                children: [
                  ...
                  purchaseData.when(data: (transaction) {
                    final filteredTransactions = transaction.where((element) {
                      ...
                      return (fromDate.isBefore(date) || fromDate.isAtSameMomentAs(date)) &&
                          (toDate.isAfter(date) || toDate.isAtSameMomentAs(date));
                    }).toList();
                                                      ...
                                                      children: [
                                                        Container(
                                                          ...
                                                          child: Text(
                                                            ...
                                                            style: TextStyle(color: filteredTransactions[index].dueAmount! <= 0 ? const Color(0xff0dbf7d) : const Color(0xFFED1A3B)),
                                                          ),
                                                        ),
                                                            ...
                                                            onPressed: () async {
                                                              if ((Theme.of(context).platform == TargetPlatform.android)) {
                                                                ...
                                                                PrintPurchaseTransactionModel model =
                                                                    PrintPurchaseTransactionModel(purchaseTransitionModel: filteredTransactions[index], personalInformationModel: data);
                                                            ...
                                                            return Row(
                                                              children: [
                                                                IconButton(
                                                                  padding: EdgeInsets.zero,
                                                                  visualDensity: const VisualDensity(horizontal: -4, vertical: -4),
                                                                  onPressed: () => PurchaseInvoicePDF.generatePurchaseDocument(filteredTransactions[index], data, context, businessData),
                                                                  icon: const Icon(
                                                                ...
                                                                IconButton(
                                                                  ...
                                                                  visualDensity: const VisualDensity(horizontal: -4, vertical: -4),
                                                                  onPressed: () =>
                                                                      PurchaseInvoicePDF.generatePurchaseDocument(filteredTransactions[index], data, context, businessData, download: true),
                                                                  icon: const Icon(
                                                                ...
                                                                IconButton(
                                                                  ...
                                                                  onPressed: () =>
                                                                      PurchaseInvoicePDF.generatePurchaseDocument(filteredTransactions[index], data, context, businessData, isShare: true),
                                                                  icon: const Icon(
