  ...
  Widget _buildDataCell({
    ...
    label = Container(
      ...
      child: DefaultTextStyle(
        style: DefaultTextStyle.of(context).style.merge(effectiveDataTextStyle).copyWith(color: placeholder ? effectiveDataTextStyle.color!.withValues(alpha: 0.6) : null),
