...
class S {
  ...
  /// `LeyanPOS app is free, easy to use. In fact, it's one of the best  POS systems around the world.`
  ...
  /// `Features are the important part which makes LeyanPOS different from traditional solutions.`
  ...
  /// `Powered By Leyan Software`
  String get powerdedByLeyan {
    return Intl.message(
      'Powered By Leyan Software',
      name: 'powerdedByLeyan',
      desc: '',
      args: [],
    );
  }
